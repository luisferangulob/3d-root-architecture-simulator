...
The regression suite checks invariants across initiation, geometry, resources, taper, checkpoint resume, storage, and HPC orchestration. A compact schema-v26 fixture stores cryptographic hashes of the full deterministic scientific result record, geometry, topology, radii, axis metadata, and branch-site state for a representative case.
